...
public class JavaFXAddonExeErrorHandler implements AddonExceptionHandler {
    ...
    public void handle(NoSuchMethodException e) {
        ...
        app.displayErrorNotification("Cannot execute addon, no method found for a parameter");
    }

    @Override
    public void handle(AddonException e) {
        LOG.error(e.getMessage());
        app.displayErrorNotification("A fatal addon exception occured for " + e.getSource().getName());
    }
